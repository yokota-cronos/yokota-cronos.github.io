...
{% for m in site.data.members %}
  <div class="member-card{% if m.bio and m.bio != '' %} has-bio{% endif %}" tabindex="0">
    ...
    <div class="member-links">
      ...
      {% if m.utokyo and m.utokyo != "" %}<a class="ico ico-utokyo" href="{{ m.utokyo }}" title="UTokyo FOCUS" target="_blank" rel="noopener"><i class="fas fa-university" aria-hidden="true"></i><span class="sr-only">UTokyo FOCUS</span></a>{% endif %}
